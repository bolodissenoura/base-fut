    ...
    <>
      ...
      <main>
        <section className="flex flex-col md:flex-row h-screen items-center">
          ...
          <div className="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
            <Image src="/loginWpp.jpg" priority alt="aa" width={10000} height={10000} className="w-full h-full object-cover" />
          </div>
      ...
      flex items-center justify-center">
            ...
            <div className="w-full h-100">
              ...
              <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">Entrar no BVF</h1>
            ...
            px-4 py-3 mt-6">Log In</button>
              ...
              <p className="mt-8">Não tem uma conta? <a href="#" className="text-blue-500 hover:text-blue-700 font-semibold">Criar conta</a></p>
